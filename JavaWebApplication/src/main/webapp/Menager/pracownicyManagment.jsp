...
<body>
    ...
    <div class ="menu">    
        ...
        <ul id="menuMenager2">
            ...
            <ul id="menuMenager3">
                <li><a href="pracownicyManagmentAdd.jsp">Dodaj pracownika</a></li>
                <li><a href="pracownicyManagmentModify.jsp">Modyfikuj dane pracownika</a></li>
                <li><a href="pracownicyManagmentDelete.jsp">Usuń pracownika</a></li>
                </ul>     
