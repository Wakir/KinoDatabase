...
<body>
    ...
    <div class ="pracownikForm">
        ...
        <form id="pracownikForm" action="registerPracownikProcess.jsp" method="post"> 
            <label for="filmTitle">Tytuł</label>
            <input type="text" name="filmTitle" value = "Spanko Attack"required/><br/>
            ...
            <select name="gatunek" id="gatunek" required>
                    <option value ="tester">aaaaajajaj</option>
            </select>
            <label for="pegi">Pegi</label>

            <select name="pegi" id="pegi" required>
                    <option value ="tester">aaaaaasdajajaj</option>
            </select>
